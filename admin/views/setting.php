    ...
    <div class="card-body">
        <form action="setting.php?action=save" method="post" name="setting_form" id="setting_form">
            ...
            <div class="custom-control custom-switch">
                ...
                <label class="custom-control-label" for="login_comment"><?= lang('comment_need_logged') ?></label>
            </div>
            <div class="custom-control custom-switch">
            ...
            <div class="form-group form-inline">
                <?= lang('comment_sort') ?>: <select name="comment_order" class="form-control" style="width: 120px;">
            ...
            <div class="form-group form-inline">
                RSS<?= lang('export') ?> <input maxlength="5" style="width:80px;" value="<?= $rss_output_num ?>" type="number" min="0" class="form-control" name="rss_output_num" /> <?= lang('rss_post_num') ?>
            ...
            <div class="custom-control custom-switch">
                ...
                <label class="custom-control-label" for="isfullsearch"><?= lang('is_full_search') ?>></label>
            </div>
            <hr>
            ...
            <div class="form-group form-inline">
                <div class="custom-control custom-switch">
                    ...
                    <label class="custom-control-label" for="isthumbnail"><?= lang('generate_thumbnails') ?></label>
                </div>
                <?= lang('thumbnail_max_size')?>:
            ...
            <hr>
            <h4><?= lang('panel_settings') ?></h4>
            <div class="form-group form-inline">
                <label><?= lang('left_menu_title') ?></label>
...
<script>
    $(function() {
        ...
        // Setting interface: Auto detect site address If "Automatically detect site address" is set, set input as read-only to indicate that the item is invalid
