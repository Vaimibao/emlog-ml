...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h4 mb-0 text-gray-800 mt-3"><?= lang('page_management') ?></h1>
                                ...
                                <td>
                                    ...
                                    <?php if ($value['gid'] == Option::get('home_page_id')): ?>
                                        ...
                                        <span class="text-secondary">
                                            <span class="badge small badge-danger"><?= lang('index') ?></span> <?= lang('origin_index') ?><a href="<?= BLOG_URL ?>posts" target="_blank"><?= BLOG_URL ?>posts</a>
                                        </span>
                                    <?php endif; ?>
                                    <br>
