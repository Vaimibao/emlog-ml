    ...
    <div class="card-body">
        <form action="navbar.php?action=taxis" id="navi_form" method="post">
                                    ...
                                    <td>
                                        <?php if ($value['hide'] == 'n'): ?>
                                            <a href="navbar.php?action=hide&amp;id=<?= $value['id'] ?>"
                                                class="badge badge-primary"><?= lang('show') ?></a>
                                        <?php else: ?>
            ...
            <div class="list_footer">
                <button type="submit" class="btn btn-sm btn-success"><?= lang('save_drag_sort') ?></button>
            </div>
        </form>
    </div>
</div>
            ...
            <div class="modal-body">
                <form action="navbar.php?action=add_sort" method="post" name="navi_sort" id="navi_sort">
                    <?php if ($sorts): ?>
                        ...
                        <div class="modal-footer border-0">
                            <a class="btn btn-sm btn-link mr-auto" href="sort.php"><?= lang('add_category') ?></a>
                            <button type="button" class="btn btn-sm btn-light" data-dismiss="modal"><?= lang('cancel') ?></button>
                            <button type="submit" class="btn btn-sm btn-success"><?= lang('save') ?></button>
                        </div>
                    <?php else: ?>
                        <div>
                            <?= lang('no_categories') ?>，<a href="sort.php"><?= lang('add_category') ?></a>
                        </div>
                    <?php endif ?>
                </form>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="navbar.php?action=add_page" method="post" name="navi_page" id="navi_page">
                    ...
                    <?php else: ?>
                        <div>
                            <?= lang('no_pages') ?>，<a href="page.php?action=new"><?= lang('add_page') ?></a>
                        </div>
                    <?php endif ?>
                </form>
            </div>
