...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h4 mb-0 text-gray-800 mt-3"><?= lang('links') ?></h1>
...
<form action="link.php?action=link_taxis" id="link_form" method="post">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr style="cursor: move">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <div class="align-items-center mb-3">
                                                <p class="mb-0 m-2">
                                                    ...
                                                    <?php if ($value['hide'] === 'y'): ?>
                                                        <span class="badge badge-warning"><?= lang('hidden') ?></span>
                                                    <?php endif ?>
                                                </p>
                                ...
                                <td>
                                    <?php if ($value['hide'] == 'n'): ?>
                                        <a href="link.php?action=hide&amp;linkid=<?= $value['id'] ?>" class="badge badge-primary"><?= lang('hide') ?></a>
                                    <?php else: ?>
                                        <a href="link.php?action=show&amp;linkid=<?= $value['id'] ?>" class="badge badge-warning"><?= lang('show') ?></a>
                                    <?php endif ?>
    ...
    <div class="list_footer">
        <input type="submit" value="<?= lang('save_drag_sort') ?>" class="btn btn-sm btn-success shadow-sm" />
    </div>
</form>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content border-0 shadow">
            <div class="modal-header border-0">
                <h5 class="modal-title" id="exampleModalLabel"><?= lang('links') ?></h5>
