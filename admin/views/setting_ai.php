                        ...
                        <div class="card-body align-items-center justify-content-center">
                            <h4 class="card-title model-name">
                                <?php if ($k == $currentModelKey): ?>
                                    <?= $model ?>
                                    <span class="badge badge-success"><?= lang('_enabled') ?></span>
                                <?php else: ?>
                            ...
                            <a href="#" class="edit-link small text-primary mr-main" data-toggle="modal" data-target="#editModelModal" data-model="<?= $val['model'] ?>" data-url="<?= $val['api_url'] ?>" data-api_key="<?= $apiKey ?>" data-model_key="<?= $k ?>" style="position: absolute; bottom: 10px; right: 40px;"><?= lang('edit') ?></a>
                ...
                <div class="card h-100">
                    <div class="card-body d-flex flex-column align-items-center justify-content-center">
                        ...
                        <p class="text-center small text-muted mt-3">
                            <a href="https://www.emlog.net/docs/ai/ai_emlog" class="text-muted" target="_blank"><?= lang('support_models') ?></a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="card h-100">
                    <div class="card-body d-flex flex-column align-items-center justify-content-center">
                        <a type="button" class="" data-toggle="modal" data-target="#aiChatModal">
                            🤖<?= lang('ai_conversation') ?>
                        </a>
                        <p class="text-center small mt-3">
                            <a href="store.php?action=plu&keyword=AI" target="_blank" class="text-muted"><?= lang('get_more_ai_apps') ?></a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <form action="setting.php?action=ai_save" method="post" name="setting_ai_form" id="setting_ai_form">
                ...
                <div class="modal-footer border-0">
                    ...
                    <div id="more-config-details" class="alert alert-warning mt-2">
                        ...
                        API Key：<a href="https://platform.deepseek.com/api_keys" target="_blank"><?= lang('generate_api_key') ?></a><?= lang('_the_format_is') ?>sk-****<br>
                        Model：deepseek-chat、deepseek-reasoner<br>
                        <hr>
                        <a href="https://bigmodel.cn/" target="_blank"><?= lang('Z.ai') ?></a><br>
                        ...
                        API Key：<a href="https://platform.moonshot.cn/console/api-keys" target="_blank"><?= lang('generate_api_key') ?></a><?= lang('_the_format_is') ?>sk-****<br>
                        Model：moonshot-v1-8k、moonshot-v1-32k、moonshot-v1-128k<br>
                        <hr>
                        <a href="https://tongyi.aliyun.com/" target="_blank"><?= lang('aliyun_bailian') ?></a><br>
                        API URL：https://dashscope.aliyuncs.com/compatible-mode/v1/chat/completions
                        <br>
                        API Key：<a href="https://bailian.console.aliyun.com/?apiKey=1#/api-key" target="_blank"><?= lang('generate_api_key') ?></a><?= lang('_the_format_is') ?>sk-****<br>
                        Model：qwen-max、qwen-plus、deepseek-v3 ...
                        <hr>
                        <?= lang('only_openai_protocol')?> <a href="https://www.emlog.net/docs/ai/ai_emlog" target="_blank"><?= lang('see_more') ?></a><br>
                    </div>
                </div>
            </form>
        </div>
...
<div class="modal fade" id="editModelModal" tabindex="-1" role="dialog" aria-labelledby="editModelModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content border-0 shadow">
            <div class="modal-header border-0">
                <h5 class="modal-title" id="editModelModalLabel"><?= lang('edit_ai_model') ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
