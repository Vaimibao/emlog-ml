    ...
    <div class="card-body">
        <form action="setting.php?action=user_save" method="post" name="user_setting_form" id="user_setting_form">
            ...
            <div class="custom-control custom-switch">
                ...
                <label class="custom-control-label" for="forbid_user_upload"><?= lang('prohibit_upload_resources') ?></label>
            </div>
            <div class="form-group form-inline" id="form_att_maxsize">
                <?= lang('maximum_upload_limit_reg') ?>:<input type="number" min="0" style="width:200px;" class="form-control mx-sm-3" value="<?= $att_maxsize ?>" name="att_maxsize" /><?= lang('unit_kb') ?>
            </div>
            <div class="form-group form-inline" id="form_att_type">
                <?= lang('file_types_allowed') ?>:<input maxlength="200" style="width:500px;" class="form-control mx-sm-3" value="<?= $att_type ?>" name="att_type" /><?= lang('separated_by_commas') ?>
            </div>
            <hr>
            <div class="form-group form-inline">
                <label for="posts_name"><?= lang('user_center_article_alias') ?>: </label>
                <input class="form-control mx-sm-3" style="width:80px;" value="<?= $posts_name ?>" name="posts_name" id="posts_name" /><?= lang('user_center_article_alias_tip') ?>
            </div>
