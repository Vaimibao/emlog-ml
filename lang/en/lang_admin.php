...
//---------------------------
//admin/account.php
    'registration_disabled' => 'Registration is closed!',//'系统已关闭注册！',
    'auth_error' => 'Authentication Error',//'验证错误',
    'wrong_user_password' => 'Incorrect username or password',//'用户或密码错误',
    'captcha_error' => 'Captcha verification error',//'图形验证码错误',
    'email_wrong' => 'Invalid email address',//'错误的邮箱',
    'password_length_invalid' => 'Invalid password length',//'密码长度不合规',
    'mail_code_invalid' => 'Email verification code error',//'邮件验证码错误',

//---------------------------
//admin/ai.php
    'ai_prompt' => 'Find a sentence from famous quotes, lyrics, movie lines, novels, poems, and celebrity quotes as your personal signature, avoiding any suggestive content such as quotation marks or colons.',//'从名言、歌词、电影台词、小说、诗词、名人名言中找出一句话，作为你的个性签名，避免输出引号、冒号等任何提示性内容。'
    'ai_reply'  => '.=== Please respond politely and professionally === Please avoid outputting any suggestive content in the previous user comment.',//'。=== 请礼貌而专业的回复 === 前面这段用户评论，避免输出任何提示性内容。'

//---------------------------
//admin/article.php
    'drafts' => 'Drafts',//'草稿箱',
    '_drafts' => ' drafts',//'草稿箱',
    'publish_new' => ' Publish new',//'发新',
    'post_manage' => 'Article Management',//'文章管理',
    ...
    'enter_summary' => 'If left blank, the article content will be used as the summary...',//'如果留空，则使用文章内容作为摘要...',
...
//admin/data.php
    ...
    'backup_empty' => 'There is no data in the backup',//'数据表没有任何内容',
    'file_not_exists' => 'File does not exist',//'文件不存在',
    'import_only_emlog' => 'You can only import emlog SQL backup files',//'只能导入emlog备份的SQL文件',
    'info_illegal' => 'Submitted information is invalid',//'非法提交的信息',
    'attachment_exceed_system_limit' => 'File size exceeds the system limit',//'文件大小超过系统限制',
    'upload_failed_code' => 'Upload failed. Error code: ',//'上传文件失败,错误码: ',
    'import_only_emlog_no_change' => 'You can only import emlog backup archives, and the archive file name cannot be changed!',//'只能导入emlog备份的压缩包，且不能修改压缩包文件名！',
    'import_failed_not_read' => 'Import failed! Cannot read the file',//'导入失败！无法读取文件',
    'import_failed_not_emlog' => 'Import failed! The backup file is not an emlog backup file!',//'导入失败！该文件不是emlog的数据备份文件!',
    'import_failed_not_emlog_ver' => 'Import failed! The backup file is not compatible with emlog ' . Option::EMLOG_VERSION . ' backup files!',//'导入失败！该文件不是emlog' . Option::EMLOG_VERSION . '生成的备份!',
    ...
    'failed_to_read_backup_file' => 'Failed to read backup file, check file permissions',//'读取备份文件失败，检查文件权限'
    'not_emlog_data_file' => 'The backup file is not the emlog backup file',//'该文件不是emlog的数据备份文件',
    'not_the_current_version' => 'The data backup is not generated by the current version, please install', //'不是当前版本生成的数据备份，请安装'
    'backup_file_bad_prefix' => 'The database backup file prefix does not match the current system database prefix',//'备份文件中的数据库表前缀与当前系统数据库表前缀不一致',

//---------------------------
//admin/index.php
    'supported' => 'Supported',//'支持',
    'not_supported' => 'Not Supported',//'不支持',
    'phpinfo_disabled' => 'The phpinfo function is disabled!',//'phpinfo函数被禁用!',
    'released' => ' released',

//---------------------------
//admin/link.php
    'no_sortable_links' => 'There are no sortable links available',//'没有可排序的链接',

//---------------------------
//admin/media.php
    'upload_restricted' => 'The system has disabled resource uploading',//'系统关闭了资源上传',
...
//admin/plugin.php
    ...
    'to_register_pro' => 'Go register for Pro',//'去注册'

//---------------------------
//admin/setting.php
//    'site_address' => 'Site address',//'站点地址',
    'verification_code_not_supported' => 'Failed to enable login verification code! The server space does not support the GD graphics library',//'开启登录验证码失败! 服务器空间不支持GD图形库',
    'verification_code_comment_not_supported' => 'Failed to enable comment verification code! Server space does not support GD graphics library',//'开启评论验证码失败! 服务器空间不支持GD图形库',
    'detect_url' => 'Automatically detect site address (may be incompatible with some CDN solutions)',//'自动检测站点地址 (可能与某些CDN解决方案不兼容)',
    'email_enter_please' => 'Please enter a valid email address',//'请填写正确的邮箱',
...
//admin/setting_mail.php
    ...
    'smtp_port_info' => '(Port 465: SSL protocol, used by QQ mailbox, Netease mailbox, etc.; Port 587: STARTTLS protocol used by Outlook mailbox)',//'(端口465：SSL协议，用于QQ邮箱、网易邮箱等；端口587：Outlook邮箱使用的STARTTLS协议)',
    'send_test' => 'Send test',//'发送测试',
    'send_test_prompt' => '<b>Take QQ mailbox configuration as an example</b><br>Sender mailbox: Your QQ mailbox<br>SMTP password: See the settings at the top of QQ mailbox -> Account -> Enable IMAP/SMTP service -> Generate authorization code (i.e., SMTP password)<br>SMTP server: smtp.qq.com<br>Port: 465<br>',//'<b>以QQ邮箱配置为例</b><br>发送人邮箱：你的QQ邮箱<br>SMTP密码：见QQ邮箱顶部设置-> 账户 -> 开启IMAP/SMTP服务 -> 生成授权码（即SMTP密码）<br>SMTP服务器：smtp.qq.com<br>端口：465<br>',
    'recepient_email_enter' => 'Enter recipient email',//'输入接收邮箱',
    'send' => 'Send',//'发送',

//---------------------------
//admin/setting_user.php
    'registration' => 'Registration',//'登录注册',
    'registration_open' => 'Enable user registration',//'开启用户注册',
    ...
    'user_rights' => 'User permissions',//'用户权限',
...
//admin/store.php
    ...
    'limited_time_offer' => 'Limited time offer',//'限时优惠'
    'preferential' => 'Preferential',//'优惠'
    'download_top' => 'Download Ranking',//'下载排行榜'
    'free_top' => 'Free Ranking',//'免费排行榜'
    'paid_top' => 'Paid Ranking',//'付费排行榜'
    'all_apps' => 'All apps',//'全部应用'
    'free_apps' => 'Free apps',//'免费应用'
    'paid_apps' => 'Paid apps',//'付费应用'
    'my_apps' => 'My purchases',//'已购应用',
    'go_check' => 'Go ahead and activate it',//'去启用',
    ...
    'download_file_timeout' => 'Installation failed, download timeout',//'安装失败，下载超时',
    ...
    'plu_category_16' => 'Data acquisition',//'数据采集',
    'tpl_category_17' => 'Website navigation',//'网址导航',
    'plu_category_18' => 'WeChat ecology',//'微信生态',
    'tpl_category_19' => 'Enterprise website',//'企业展示',
    'plu_category_20' => 'Editor',//'编辑器',
    'tpl_category_21' => 'Document Library',//'文档知识库',
    'plu_category_6' => 'Function expansion',//'功能扩展',
...
//admin/template.php
    ...
    'template_used' => 'You cannot delete a template that is currently in use',//'您不能删除正在使用的模板',
...
//    'upload_insert' => 'Insert upload',//'上传插入',
    ...
    'link_alias_info' => 'English letters and numbers,for <a href="./setting.php?action=seo">SEO settings</a>',//'英文字母、数字组成，用于<a href="./setting.php?action=seo">seo设置</a>',
...
//admin/views/article.php
    ...
    'view_by_new' => 'Latest publish',//'最新发布',
    'view_by_top' => 'Top priority',//'置顶优先',
    'view_by_comment_count' => 'Most comments',//'评论最多',
    'view_by_views_count' => 'Most views',//'浏览最多',
...
// 'drafts'		=> 'drafts',//'草稿',
    ...
    'posts' => 'Posts',//'文章',
    'deleted_permanently' => 'Delete permanently',//'彻底删除'
    'deleted_select_draft' => 'Delete selected draft?',//'删除所选草稿？'
    'select_article' => 'Please select the article to operate',//'请选择要操作的文章',
    'deleted_not_recoverable' => 'Deleted will not be recoverable',//'彻底删除将无法恢复'
    ...
    'tag_separated' => 'Multiple labels are separated by English commas',//'多个标签用英文逗号分隔'
    'top' => 'Top',//'置顶',
    'unknown_cate' => 'Unknown category',//'未知分类',
...
//admin/views/article_write.php
    ...
    'publish_time_tips' => 'When a future time is set, the article will be regularly published after that time',//'当设置未来的时间点时，文章将在该时间点后定时发布',
    'access_password' => 'Access Password:',//'访问密码：',
    'article_template' => 'Article Template:',//'文章模板：',
    'choose_file' => 'Select a file to upload...',//'选择文件上传...',
    'tags_have' => 'Have tags+',//'已有标签+',
    'post_tags_separated' => 'Article tags, separated by commas',//'文章标签，使用逗号分隔',
    'resource_library' => 'Resources Library',//'资源媒体库',
    ...
    'article_cover' => 'Cover Image:',//'封面图',
    'crop_upload' => 'Upload cover',//'上传封面',
    'uploading' => 'Uploading...',//'上传中……',
    'cover_placeholder' => 'Fill in the cover image URL or click below to upload',//'填写封面图URL或点击下方上传',
    'cover_image' => 'Cover image',//'封面图片',
    'automatically_obtain_cover' => 'Automatically obtain images from the content as the cover',//'自动获取文中图片作为封面',
    'recently_used' => 'Recently used+',//'近期使用的+',
    'recently_used_tip' => 'Also used for page keywords, separated by commas in English',//'也用于页面关键词，英文逗号分隔',
    'jump_link' => 'Jump link:',//'跳转链接：',
    'jump_link_info' => 'Directly redirect to this address without displaying the content after filling it in',//'填写后不展示内容直接跳转该地址',
    ...
    'summary_optional' => 'Summary(optional):',//'摘要（选填）：',
    'extract_summary' => 'Automatically extract summary',//'自动截取摘要',
    'add_field' => 'Add fields',//'添加字段',
    'field_name' => 'Field name',//'字段名称',
    'field_name2' => 'Field name second',//'字段名称2',
    'field_value' => 'Field value',//'字段值',
    'plugin_manage_act' => 'Plugin extension:',//'插件扩展：',
    'advanced_options' => 'Advanced Options',//'高级选项',
    'cover_picture_tip' => 'Hold down the Shift key to adjust the crop region proportionally',//'按住 Shift 等比例调整裁剪区域',
    'use_original_picture' => 'Use original picture',//'使用原图',
    'only_upload_pictures' => 'Only pictures can be uploade',//'只能上传图片',
    'upload_pictures_error' => 'Error uploading cover',//'上传封面出错了',
    'upload_error' => '上传出错了',//'Upload error',
    'reload_page_tip' => 'Prompt for leaving the page',//'离开页面提示',
...
//admin/views/admin_page.php
    ...
    'page_disabled_ok' => 'Page has been convert to draft successfully',//'转为草稿成功',
...
//    'delete' => 'Delete',//'删除',
    ...
    '_pages' => ' pages',//'个页面',
    'select_page_to_operate' => 'Please select a page to operate on',//'请选择要操作的页面',
    'sure_delete_selected_pages' => 'Are you sure you want to delete the selected pages?',//'确定要删除所选页面吗？',
    'pages_total' => 'Total pages:',//'已创建了',
    'alias' => 'Alias',//'别名',
    'index' => 'Index',//'首页',
    'set_as_index' => 'Set as Index',//'设为首页',
    'origin_index' => 'It has been set as the home page. The original default home page:',//'已设为首页，原默认首页：',
...
//admin/views/auth.php
    'ext_store_info' => 'The extension store is used for downloading templates and plugins and is only accessible to registered users',//'扩展商店用于下载模板和插件，仅开放给已完成注册用户',
    'too_many_articles' => 'The number of articles has exceeded the unregistered version limit',//'文章数量已经超过未注册版本限额',
    'emlog_notregistered' => 'Sorry! Your emlog pro has not been registered yet. Complete the registration to unlock all the features of emlog pro',//'抱歉！您的emlog pro尚未完成注册， 完成注册来解锁emlog pro的全部功能',
...
//admin/views/blogger.php
    ...
    'nickname_is_empty' => 'Nickname cannot be empty',//'昵称不能为空',
    ...
    'login_name_tip' => 'If username is empty, use email to log in',//'未设置用户名时，请使用邮箱登录',
    'new_password_info' => 'New Password (not less than 5 characters, left blank if do not need to modify)',//'新密码（不小于5位，不修改请留空）',
    'new_password_repeat' => 'Confirm new password',//'再输入一次新密码',
    'save_data' => 'Save Data',//'保存资料',
    'modify_password' => 'Change Password',//'修改密码',
    'modify_password_tip' => 'The password has been modified successfully. Please log out and log in again',//'密码修改成功, 请退出重新登录',
    'api_interface' => 'API',//'API',
    'account_password' => 'Account password',//'账号密码',
    'crop_and_upload' => 'Crop and upload',//'裁剪并上传',
    'modify_email' => 'Change E-mail',//'修改邮箱',
    'modify_email_tip' => 'E-mail modified successfully',//'邮箱修改成功',
    'send_email_again' => 'Resend',//'重新发送',
    'ai_request_failed' => 'AI request failed, please try again later',//'AI 请求失败，请稍后再试',
    'password_strength' => 'Password strength: ',//'密码强度：',
    'password_strength_strong' => 'Strong',//'强',
    'password_strength_medium' => 'Medium',//'中等',
    'password_strength_weak' => 'Weak',//'弱',
...
//admin/views/comment.php
    ...
    'no_comments_yet' => 'No comments yet',//'还没有收到评论',
...
//admin/views/data.php
    'data_backup' => 'Data',//'数据',
    'backup_prompt' => 'Back up the site content database to your computer,Including articles, comments, users and other information, but excluding uploaded file images',//'将站点内容数据库备份到自己电脑上，包括文章、评论、用户等信息，但不包括上传的文件图片。',
...
//admin/views/footer.php
    ...
    'ai_conversation' => 'AI conversation',//'AI 对话',
    'input_ai_msg' => 'Input message...',//'输入消息...',
    'no_ai_model' => 'No AI model configured',//'未配置AI模型',
    'ai_connection_error' => 'Connection error, possibly model configuration or network problem',//'连接出错，可能是模型配置或者网络问题',
    'press_shift_enter' => ', press Shift+Enter to wrap',//'，按 Shift + Enter 换行',
    'error_parsing_stream_data' => 'Error parsing stream data',//'解析流数据错误',
    'no_shortcuts' => 'No shortcuts available',//'没有可用的快捷方式'
    '_load_failed' => 'Load failed: ',//'加载失败: ',

//---------------------------
//admin/views/header.php
    'admin_center' => 'AdminCP',//'控制台',
    'return_to_admin_center' => 'Return to AdminCP',//'返回管理首页',
    'to_site_new_window' => 'Open site in new window',//'在新窗口浏站点',
...
//    'extensions' => 'Extensions',//'扩展',//'扩展功能',
    'search_for' => 'Search for title...',//'搜索标题...',
...
//admin/views/index.php
    'set_successfully' => 'Set successfully',//'设置成功',
    'welcome' => 'Welcome',//'欢迎',
    'admincp' => 'AdminCP',//'管理后台',
    'link_manage_info' => 'Friendship link management. You can display the added links in the sidebar on the homepage through sidebar management.',//'友情链接管理，可以在侧边栏管理中将该处添加的链接展示在首页侧边栏。',
    ...
    'update_download_failed' => 'Download of the update failed, there may be a network problem',//'下载更新失败，可能是服务器网络问题',
    'update_extract_failed' => 'Extraction of the update failed, your server may not support the zip extension',//'解压更新失败，可能是你的服务器空间不支持zip模块',
    ...
    '_recent_post' => 'Recently published',//'最近发布的',
    'last_comments' => 'Recent comments',//'最近收到的评论',
    'svip_hard' => 'Hardcore SVIP Edition',//'铁杆SVIP版',
    'vip_friend' => 'Friendship VIP Edition',//'友情VIP版',
    '_svip' => 'Hardcore SVIP',//'铁杆SVIP',
    '_vip' => 'Friendship VIP',//'友情VIP',
    'applied_today' => 'Applied today',//'今日应用',
    'app_development' => 'Application Development | Development Documentation',//'应用开发 | 开发文档',
    'tips_plugin'		=> 'Tips',//'小贴士',
    'tpl_plugin'		=> 'Template options',//'模版设置',
    'update' => 'Update',//'更新',
    'free_install_applications_tip' => 'users can install the following applications for free',//'用户可以免费安装下面的应用',
...
//admin/views/links.php
    ...
    'link_logo_url' => 'Logo URL',//'图标URL',
    'site_and_url_empty' => 'Site name and address can not be empty',//'名称和地址不能为空',
    'save_drag_sort' => 'Save Drag Sort',//'保存拖动排序',

//---------------------------
//admin/views/login.php
    'login' => 'Login',//'登录',
    'user_name' => 'Username',//'用户名',
    'user_name_email' => 'User name\E-mail',//'用户名\邮箱',
    'user_name_edit' => 'Username (if it is empty, use email to log in)',//'用户名（为空则使用邮箱登录）',
    ...
    'validation_error_tip' => 'Validation error, please re-enter',//'验证错误，请重新输入',
    'password_invalid' => 'User or password incorrect, please re-enter',//'用户或密码错误，请重新输入',
    'account_forbid' => 'The account has been forbidden',//'账号已被停用',
...
//admin/views/media.php
    ...
    'resource_move' => 'Please select the resource to be moved',//'请选择要移动的资源',
...
//    'founder' => 'Founder',//'创建人',
    ...
    'media_category_add_ok' => 'Successfully added',//'添加成功',
    '_name_empty'      => 'Name can not be empty',//'名称不能为空',
...
//admin/views/navbar.php
    ...
    'nav_add_category_btn' => 'Add categories',//'添加分类',
    'nav_page_add_btn' => 'Add pages',//'添加页面',
    'id' => 'ID',//'序号',
    'navigation' => 'Navigation',//'导航',
    'type' => 'Type',//'类型',
    'status' => 'Status',//'状态',
...
//admin/views/page_create.php
    'default' => 'Default',//'默认',
    'select_tmpl_option' => 'Select the page template supported by the current template(optional)',//'选择当前模板支持的页面模板（可选）',
...
//admin/views/plugin.php
    'plugin_manage' => 'Plugins',//'插件扩展',
    'plugin_upload_ok' => 'Plugin uploaded successfully, please activate it to use',//'插件上传成功，请开启使用',
    'plugin_active_ok' => 'Plugin activated successfully',//'插件开启成功',
    'plugin_active_failed' => 'Plugin activation failed',//'插件开启失败',
    'plugin_disable_ok' => 'Plugin disabled successfully',//'插件禁用成功',
...
//admin/views/plugin_install.php
    ...
    'plugin_system_dep' => 'System dependent plugins, please do not delete or close them',//'系统依赖插件，请勿删除和关闭',
    'enabled' => 'Enabled',//'已开启',
    'disabled' => 'Disabled',//'未开启',
    '_enabled' => 'Enabled',//'已启用',
    '_disabled' => 'Disabled',//'未启用',
    '_enable' => 'Enable',//'启用',
    '_disable' => 'Disable',//'禁用',
    'plugin_select' => 'Select plugin package',//'选择插件安装包',
...
//admin/views/register.php
    ...
    'password_short' => 'Password must not be less than 6 characters',//'密码不小于6位',

//---------------------------
//admin/views/reset.php
    'retrieve_password' => 'Retrieve password: verify email',//'找回密码：验证邮箱',
    'new_password' => 'New password',//'新的密码',
    'new_password_tip' => 'New password(no less than 6 characters)',//'新的密码（不少于6位）',
    'confirm_password' => 'Repeat the new password',//'重复新的密码',
    ...
    'verification_error' => 'Graphic verification code error',//'图形验证码错误',
...
//admin/views/reset2.php
    ...
    'send_verification_code_tip' => 'The verification code has been sent, please check the email',//'验证码已发送，请查收邮件',
...
//admin/views/seo.php
    ...
    'meta_keywords' => 'Site keywords (keywords), multiple are separated by English commas',//'站点关键字(keywords)，多个用英文逗号分隔',
...
//admin/views/setting.php
    ...
    'per_page_show' => ',Show per page',//'，每页显示',
    '_posts' => ' post(s)',//'篇文章',
    ...
    'offline_writing' => 'Offline Writing (Support for tools like Windows Live Writer)',//'离线写作（支持用Windows Live Writer等工具写文章）',
    ...
    'auto_summary_length' => 'Auto intercept',//'自动截取',
    'characters_as_summary' => ' characters as summary',//'个字作为摘要',
    ...
    'comment_need_logged' => 'Comment after login. Only login users can comment after opening',//'登录后评论，开启后仅登录用户可评论',
    ...
    'php_upload_max_size' => 'Server PHP upload configuration',//'上传文件还受到服务器空间PHP配置最大上传',
    'allow_attach_type' => 'Allow attachment types to upload',//'允许上传的附件类型',
    'separate_by_comma' => ' (Separate multiple values by commas)',//'（多个用半角逗号分隔）',
    'generate_thumbnails' => 'Uploaded pictures generated thumbnail',//'上传图片生成缩略图',
    'thumbnail_max_size' => ',maximum size: ',//'，最大尺寸：',
    'unit_pixels' => ' (Unit: pixels)',//'（单位：像素）',
    'unit_kb' => '(Unit: KB)',//'（单位：KB）',
    'icp_reg_no' => 'ICP Reg.&nbsp;No.',//'ICP备案号',
    'home_footer_info' => 'Footer info on the home page',//'首页底部信息',
    ...
    'is_full_search' => 'Full text search (enabling when there are many articles may affect the site performance)',//'全文搜索（文章较多时开启可能会影响站点性能）',
    ...
    'panel_settings' => 'Panel Settings',//'面板设置',
    'left_menu_title' => 'Left menu title',//'左侧菜单标题',
...
//admin/views/setting_ai.php
    ...
    'support_models' => 'View the list of support models',//'查看支持模型列表',
    'get_more_ai_apps' => 'Get more AI apps from the App Store',//'应用商店更多AI应用',
    'add_ai_model' => 'Add AI model',//'添加AI模型',
    'edit_ai_model' => 'Edit AI model',//'编辑AI模型',
    'generate_api_key' => 'Generate api key',//'生成api key',
    '_the_format_is' => ', the format is as follows:',//'，格式如：',
    'Z.ai' => 'Z.ai',//'智谱AI',
    'aliyun_bailian' => 'Aliyun Bailian',//'阿里百炼',
    'see_more' => 'See more',//'查看更多',
    'only_openai_protocol' => 'Only the large model of openai protocol can be configured,',//'仅支持配置openai协议的大模型，',

//---------------------------
//admin/views/setting_api.php
    'api_key_reset_ok' => 'API key reset successful',//'接口秘钥重置成功',
    ...
    'api_1' => '1. Publish article (can be used for docking with content publishing software)',//'文章发布 (可用于对接内容发布软件)',
    'api_1_tip' => 'It can be used to dock with the content publishing software. The URL of the article publishing interface is:',//'可用于对接内容发布软件，文章发布接口URL：',
    'api_2' => '2. Categories list',//'2. 分类列表',
    'api_3' => '3. Publish note',//'3. 微语发布',
    'api_4' => '4. Note list',//'4. 微语列表',
    'api_5' => '5. Upload resource file',//'4. 资源文件上传',
...
//admin/views/setting_mail.php
    ...
    'from_site' => 'From site',//来自站点'
    'mail_template' => 'Mail Template',//'邮件模板'
    'mail_template_1' => 'Simplicity',//'简约'
    'mail_template_2' => 'Dark Blue',//'深蓝'
    'mail_template_3' => 'Grass green',//'草绿'
    'mail_template_tip' => 'Mail template (html is supported). Please leave blank if you do not use the template.',//'邮件模板(支持html)，不使用模板请留空。'
    'select_mail_template' => 'Select a template:',//'选择模板：'
    '_template_variables' => 'Template variables:',//'模板变量：'
    '_mail_content' => 'Message content,',//'邮件内容，'
...
//admin/views/setting_user.php
    ...
    'groups_alert' => 'Registered users: can post and contribute articles, manage their own articles, graphic resources, etc.<br>
					Content editor: Responsible for the management of articles, resources, comments, etc.<br>
					Administrator: has all the management rights of the site, can manage users, make system settings, etc.<br>',
    //'注册用户：可以发文投稿、管理自己的文章、图文资源等<br>
    //内容编辑：负责文章、资源、评论等内容的管理<br>
    //管理员：拥有站点全部管理权限，可以管理用户、进行系统设置等<br>',
    'limit_daily_posts' => 'Registered users limit the number of posts (including drafts, 0 is prohibited from posting articles) within 24 hours',//'注册用户限制24小时发文数量（包括草稿，0为禁止发文）',
    ...
    'if_0_upload_disabled' => 'If set to 0, simultaneous publishing of notes and uploading graphic resources is disabled',//'为0同时禁止发布微语和上传图文资源',
    'prohibit_upload_resources' => 'Prohibit registered users from uploading pictures and file resources',//'禁止注册用户上传图文资源'
    'maximum_upload_limit_reg' => 'Maximum upload limit for registered users',//'注册用户上传最大限制'
    'file_types_allowed' => 'File types allowed to be uploaded by registered users',//'允许注册用户上传的文件类型'
    'separated_by_commas' => '(Multiple are separated by commas in English)',//'（多个用英文逗号分隔）'
    'user_center_article_alias' => 'User Center article text alias',//'用户中心文章别名'
    'user_center_article_alias_tip' => 'For example: posts, contributions, resources, etc',//'如：帖子、投稿、资源等'
...
//admin/views/sort.php
    ...
    'alias_prompt' => 'Composed of English letters, used for seo setting',//'英文字母组成，用于seo设置',
...
//admin/views/sort_edit.php
    'category_title' => 'Title (used for the title of the category page)',//'标题（用于分类页的 title）',
    'category_description' => 'Category description',//'分类描述',
    'category_description_tip' => 'Description (for description of category page)',//'描述（用于分类页的 description）',
    'category_kw' => 'Keywords (used for keywords on the category page, separated by commas in English)',//'关键词（用于分类页的 keywords，英文逗号分割）',
    'category_template' => 'Category template',//'分类模板',
    'category_template_intro' => '(Select the category template supported by the current template)',//'(选择当前模板支持的分类模板)',
    'custom_template_intro' => '(Used to customize the category page template, corresponding to the xxx.php file in the template directory, where xxx is the template name)',//'(用于自定义分类页面模板，对应模板目录下xxx.php文件，xxx即为模板名)',
    'zero_global_settings' => 'If 0, use global settings',//'为0则使用全局设置',
    'support_variables' => 'Support variables',//'支持变量',
...
// 'back_home'				=> 'Back to home',//'返回首页',
    ...
    'ext_store_templates' => 'Templates',//'模板主题',
// 'template'				=> 'Template',//'模板',
...
//admin/views/store_install.php
    ...
    'plugin_download_failed' => 'Download failed. It may be due to a network issue. Please download and install manually.',//'下载失败，可能是服务器网络问题，请手动下载安装，',
...
//admin/views/tag.php
    ...
    'modify_tag' => 'Modify tag',//'修改标签',
    'tag_name' => 'Tag name',//'标签名',
    'tag_page_title' => 'Tag page title',//'标签页标题',
    'tag_page_kw' => 'Tag page keywords (separated by commas in English)',//'标签页关键词（用英文逗号分割）',
    'tag_page_description' => 'Tag page description',//'标签页描述',
...
//admin/views/template.php
    ...
    'detailed_information' => 'Detail',//'详细信息',
    'select_template_package' => 'Select template file package',//'选择模板安装包',
    'upload_template_package_tip' => 'Please upload the template file package in zip format',//'请上传zip格式的模板安装包',
...
//admin/views/template_crop.php
    ...
    'crop_load_prompt' => '(If the selection area does not appear after the page has finished loading, press the left mouse button to manually drag and select.)',//'(页面加载完毕后，未出现选择区域时请按下鼠标左键手动拖曳选取)',
...
//admin/views/twitter.php
    'twitter_del_ok' => 'Note deleted successfully',//'微语删除成功',
    'twitter_empty' => 'Note content cannot be empty',//'微语内容不能为空',
    'twitter_add' => 'Add a note',//'卡片微语',
    'twitter_prompt' => 'Capture fleeting thoughts and record every bit of life',//'捕捉稍纵即逝的想法，记录生活中的点点滴滴',
    'twitter_save' => 'Save the note',//'保存微语',
    'twitters' => 'Notes',//'微语',
    '_twitters' => ' note(s)',//'条微语',
    'twitter_edit' => 'Edit note',//'编辑微语',
    'twitter_post_disabled' => 'Sorry, the system restricts users from posting notes',//'抱歉，系统限制用户发布微语',
    'private' => 'Private',//'私密',

//---------------------------
//admin/views/uc_index.php
    'registered_user' => 'Registered user',//'注册用户'
    'is_empty' => 'This is empty.',//'这里是空的。',
...
//admin/views/upload_multi.php
    'browser_upgrade' => 'Your browser is too old to display this feature. You cannot use the bulk upload. Please, upgrade your web browser or switch to another.',//'您正在使用的浏览器版本太低，无法使用批量上传功能。为了更好地使用emlog，建议您升级浏览器或者换用其他浏览器。',
...
//    'posts_need_audit' => 'Posts need to be verified',//'(文章需审核)',
    ...
    'search_by_email' => 'Enter email address or username to search...',//'输入邮箱或用户昵称搜索...',
    'email_empty' => 'E-mail can not be empty',//'邮箱不能为空',
    'email_user_name_empty' => 'Both E-mail and username cannot be empty',//'邮箱和用户名不能都为空',
    ...
    'banned' => 'Banned',//'已禁用',
    'unban' => 'Unban',//'解禁',
    'recently_registered' => 'Recently registered',//'最近注册',
    'recently_active' => 'Recently active',//'最近活跃',
    'management_priority' => 'Management priority',//'管理优先',
    'forbidden_priority' => 'Forbidden priority',//'禁用优先',
    'points' => 'Points',//'积分',
    '_users_per_page' => 'user(s), displayed per page',//'个用户，每页显示',
    'select_user' => 'Please select a user',//'请选择用户',
    '_selected_users' => 'selected users',//'所选用户',
...
//admin/views/widgets.php
    ...
    'sidebar' => 'Sidebar',//'侧边栏',
    'show_count' => 'Display quantity',//'展示数量',
