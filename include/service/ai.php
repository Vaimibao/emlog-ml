...
class Ai
{
    public static function chat($prompt, $system_prompt = '')
    {
        $system_prompt = empty($system_prompt) ? lang('useful_assistant') : $system_prompt;
        $messages = [
            [
    ...
    public static function chatStream($prompt, $system_prompt = '')
    {
        $system_prompt = empty($system_prompt) ? lang('useful_assistant') : $system_prompt;
        $messages = [
            [
    ...
    private static function formatResponse($response)
    {
        ...
        return lang('model_processing_exception') . $response;
    }
